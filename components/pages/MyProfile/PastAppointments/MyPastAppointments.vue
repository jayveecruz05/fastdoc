...
<script lang="ts" setup>
  ...
  const appointmentList = [
    { id: 1, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Cough', 'Flu', 'Fever'], date: '2024/01/01', status: 'pending' },
    { id: 2, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Constant lower back pain', 'insomnia'], date: '2024/01/01', status: 'closed', findings: 'Inflammation on right Lumborum muscle caused by physical strain', recommended: 'Rest for 3-5 days, take anti-inflammatory drugs twice a day', npi: '123456789' },
    { id: 3, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Cough', 'Flu', 'Fever'], date: '2024/01/01', status: 'pending' },
    { id: 4, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Constant lower back pain', 'insomnia'], date: '2024/01/01', status: 'closed', findings: 'Inflammation on right Lumborum muscle caused by physical strain', recommended: 'Rest for 3-5 days, take anti-inflammatory drugs twice a day', npi: '123456789' },
    { id: 5, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Cough', 'Flu', 'Fever'], date: '2024/01/01', status: 'pending' },
    { id: 6, image: doctorPhoto, name: 'Dr. Lisa Parker', specialization: 'Geriatrician', symptoms: ['Constant lower back pain', 'insomnia'], date: '2024/01/01', status: 'closed', findings: 'Inflammation on right Lumborum muscle caused by physical strain', recommended: 'Rest for 3-5 days, take anti-inflammatory drugs twice a day', npi: '123456789' }
  ];
